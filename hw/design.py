...
SW_TACT = 'Button_Switch_SMD:SW_SPST_SKQG_WithStem'   # 5.1x5.1 mm 4-pad SMD tactile: XKB TS-1187A-B-A-B (JLC Basic) = Alps SKQG land pattern
...
def build():
    ...
    U1 = Part('U1', 'RF_Module:ESP32-S3-WROOM-1', 'ESP32-S3-WROOM-1-N16R8', 'RF_Module:ESP32-S3-WROOM-1',
              {'1': 'GND', '40': 'GND', '41': 'GND', '2': '+3V3', '3': 'EN',
               ...
               '36': 'RXD0', '37': 'TXD0'},
              lcsc='C2913202', mpn='ESP32-S3-WROOM-1-N16R8', desc='ESP32-S3 WiFi/BLE module, 16 MB flash + 8 MB PSRAM, PCB antenna',
              sch_pos=(200, 80), pcb_pos=(30, 6.75), pcb_rot=0)
    ...
    d.add(Part('U3', 'Interface_UART:SP3485EN', 'SP3485EN', SOIC8,
               ...
               lcsc='C8963', mpn='SP3485EN-L/TR', desc='RS-485 transceiver 3.3 V half-duplex SOIC-8 (MAX3485 pin-compatible)', sch_pos=(300, 60), pcb_pos=(48, 12), pcb_rot=0))
    d.add(Part('C7', 'Device:C', '100nF', C0603, {'1': '+3V3', '2': 'GND'}, lcsc='C14663', desc='100nF 50V X7R 0603', sch_pos=(280, 45), pcb_pos=(48, 7), pcb_rot=0))
    d.add(Part('R7', 'Device:R', '10k', R0603, {'1': 'DMX_DE', '2': 'GND'}, lcsc='C25804', desc='10k 0603 (DE pull-down: receiver idle until firmware drives)', sch_pos=(282, 90), pcb_pos=(44, 17), pcb_rot=0))
    d.add(Part('D1', 'Diode:SM712_SOT23', 'PSM712', SOT23, {'1': 'DMX_A', '2': 'DMX_B', '3': 'GND'},
               lcsc='C32677', mpn='PSM712-LF-T7', desc='RS-485 TVS array +12/-7 V 600 W SOT-23', sch_pos=(330, 90), pcb_pos=(54, 20), pcb_rot=0))
    ...
    d.add(Part('J2', 'Connector_Audio:XLR5_Ground', 'XLR-5 female (DMX OUT)', 'Connector_Audio:Jack_XLR_Neutrik_NC5FAH_Horizontal',
               ...
               lcsc='C368501', mpn='NC5FAH', desc='Neutrik XLR 5-pin female, horizontal PCB mount (DMX OUT)', sch_pos=(385, 60), pcb_pos=(62.85, 16.5), pcb_rot=0))
    d.add(Part('J3', 'Connector:Screw_Terminal_01x03', 'DMX pigtail', 'TerminalBlock_Phoenix:TerminalBlock_Phoenix_MKDS-1,5-3-5.08_1x03_P5.08mm_Horizontal',
               {'1': 'GND', '2': 'DMX_B', '3': 'DMX_A'}, lcsc='C474953', mpn='KF128-5.08-3P-AA', desc='Screw terminal 3P 5.08 mm (alt. DMX wire output: GND, D-, D+)',
               sch_pos=(385, 95), pcb_pos=(50.5, 48.5), pcb_rot=0, drill=1.4))
    ...
    d.add(Part('J4', 'Connector_Generic:Conn_01x06', 'EXPANSION', 'Connector_PinHeader_2.54mm:PinHeader_1x06_P2.54mm_Vertical',
               ...
               lcsc='C37208', mpn='2.54-1x6P', desc='Pin header 1x6 2.54 mm', sch_pos=(300, 190), pcb_pos=(43, 22), pcb_rot=0))
    d.add(Part('J5', 'Connector_Generic:Conn_01x04', 'UART0', 'Connector_PinHeader_2.54mm:PinHeader_1x04_P2.54mm_Vertical',
               ...
               lcsc='C124378', mpn='B-2100S04P-A110', desc='Pin header 1x4 2.54 mm', sch_pos=(360, 190), pcb_pos=(47.5, 22), pcb_rot=0))
    # =============================== Mechanical ===============================
    ...
    # ---------------------------------------------------------------- PCB extras
    d.keepouts = []   # antenna hangs off the top edge, so no on-board keep-out is required
    d.silk = [
