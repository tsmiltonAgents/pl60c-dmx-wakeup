...
def build():
    ...
    d.add(Part('F1', 'Device:Polyfuse', '0.75A PTC', 'Fuse:Fuse_1206_3216Metric', {'1': 'VBUS', '2': '+5V'},
               lcsc='C70069', desc='PTC resettable fuse 1206, 0.75 A hold', sch_pos=(70, 40), sch_rot=90, pcb_pos=(12, 6), pcb_rot=0))
    ...
    d.add(Part('SW1', 'Switch:SW_Push', 'RESET', SW_TACT, {'1': 'EN', '2': 'GND'}, lcsc='C318884', desc='Tactile switch 6x6 SMD', sch_pos=(150, 90), pcb_pos=(12.5, 48), pcb_rot=0))
    d.add(Part('R4', 'Device:R', '10k', R0603, {'1': '+3V3', '2': 'IO0_BOOT'}, lcsc='C25804', desc='10k 0603', sch_pos=(150, 110), pcb_pos=(23.5, 42.5), pcb_rot=0))
    d.add(Part('SW2', 'Switch:SW_Push', 'BOOT', SW_TACT, {'1': 'IO0_BOOT', '2': 'GND'}, lcsc='C318884', desc='Tactile switch 6x6 SMD', sch_pos=(150, 130), pcb_pos=(23.5, 48), pcb_rot=0))
    ...
    d.add(Part('U3', 'Interface_UART:MAX3485', 'MAX3485', SOIC8,
               ...
               lcsc='C6785', mpn='MAX3485ESA+T', desc='RS-485 transceiver 3.3V half-duplex SOIC-8', sch_pos=(300, 60), pcb_pos=(48, 12), pcb_rot=0))
    ...
    d.add(Part('D1', 'Diode:SM712_SOT23', 'SM712', SOT23, {'1': 'DMX_A', '2': 'DMX_B', '3': 'GND'},
               lcsc='C58274', mpn='SM712', desc='RS-485 TVS array +12/-7V SOT-23', sch_pos=(330, 90), pcb_pos=(54, 20), pcb_rot=0))
    ...
    d.add(Part('SW3', 'Switch:SW_Push', 'USER', SW_TACT, {'1': 'BTN_USER', '2': 'GND'}, lcsc='C318884', desc='Tactile switch 6x6 SMD (snooze / manual on)', sch_pos=(200, 215), pcb_pos=(34.5, 48), pcb_rot=0))
    ...
    d.add(Part('D3', 'Diode:1N4148W', '1N4148W', 'Diode_SMD:D_SOD-123', {'1': '+5V', '2': 'BZ_N'}, lcsc='C81598', desc='Flyback diode SOD-123', sch_pos=(255, 225), sch_rot=90, pcb_pos=(59.5, 37), pcb_rot=0))
    d.add(Part('BZ1', 'Device:Buzzer', 'MLT-8530', 'Buzzer_Beeper:MagneticBuzzer_CUI_CMT-8504-100-SMT', {'1': '+5V', '2': 'BZ_N'},
               lcsc='C94599', mpn='MLT-8530', desc='Magnetic buzzer 8.5 mm SMD, 3-5 V, passive (drive with PWM ~2.7 kHz)', sch_pos=(245, 200), sch_rot=0, pcb_pos=(69, 41.5), pcb_rot=0))
    ...
    d.add(Part('J4', 'Connector_Generic:Conn_01x06', 'EXPANSION', 'Connector_PinHeader_2.54mm:PinHeader_1x06_P2.54mm_Vertical',
               ...
               lcsc='C2337', desc='Pin header 1x6 2.54 mm', sch_pos=(300, 190), pcb_pos=(43, 22), pcb_rot=0))
