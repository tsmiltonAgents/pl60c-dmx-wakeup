...
def build():
    ...
    d.rev = 'A-mini'
    d.board = dict(w=38.5, h=28.0, corner=0.6, layers=4, usb_vbus_via=4.4)
    ...
    d.add(Part('J1', 'Connector:USB_C_Receptacle_USB2.0_16P', 'USB-C 16P', 'Connector_USB:USB_C_Receptacle_HRO_TYPE-C-31-M-12',
               ...
               sch_pos=(45, 65), pcb_pos=(6.4, 24.9), pcb_rot=0))
    d.add(Part('R1', 'Device:R', '5.1k', R0402, {'1': 'CC1', '2': 'GND'}, lcsc='C25905', desc='5.1k 0402 1% (USB-C CC pull-down)', sch_pos=(75, 80), pcb_pos=(3.4, 27.2), **B))
    d.add(Part('R2', 'Device:R', '5.1k', R0402, {'1': 'CC2', '2': 'GND'}, lcsc='C25905', desc='5.1k 0402 1% (USB-C CC pull-down)', sch_pos=(85, 80), pcb_pos=(9.4, 27.2), **B))
    d.add(Part('U4', 'Power_Protection:USBLC6-2SC6', 'USBLC6-2SC6', SOT23_6,
               {'1': 'USB_D+', '6': 'USB_D+', '3': 'USB_D-', '4': 'USB_D-', '2': 'GND', '5': 'VBUS'},
               lcsc='C7519', mpn='USBLC6-2SC6', desc='USB ESD protection array', sch_pos=(100, 100), pcb_pos=(6.4, 26.0), pcb_rot=0, **B))
    d.add(Part('F1', 'Device:Polyfuse', '0.75A PTC', 'Fuse:Fuse_0805_2012Metric', {'1': 'VBUS', '2': '+5V'},
               lcsc='C7472571', mpn='0805L075/6AR', desc='PTC resettable fuse 0805, 0.75 A hold, 6 V', sch_pos=(70, 40), pcb_pos=(13.6, 17.6), **B))
    d.add(Part('C1', 'Device:C', '10uF', C0603, {'1': '+5V', '2': 'GND'}, lcsc='C19702', desc='10uF 10V X5R 0603', sch_pos=(82, 50), pcb_pos=(3.0, 19.0), pcb_rot=90, **B))
    d.add(Part('U2', 'Regulator_Linear:AP2112K-3.3', 'AP2112K-3.3', SOT23_5,
               ...
               sch_pos=(100, 40), pcb_pos=(13.8, 21.5), **B))
    d.add(Part('C2', 'Device:C', '10uF', C0603, {'1': '+3V3', '2': 'GND'}, lcsc='C19702', desc='10uF 10V X5R 0603', sch_pos=(115, 50), pcb_pos=(14.5, 24.3), **B))
    d.add(Part('C3', 'Device:C', '100nF', C0402, {'1': '+3V3', '2': 'GND'}, lcsc='C1525', desc='100nF 16V X7R 0402', sch_pos=(122, 50), pcb_pos=(10.6, 19.3), pcb_rot=90, **B))
    ...
    U1 = Part('U1', 'RF_Module:ESP32-S3-MINI-1', 'ESP32-S3-MINI-1-N8', 'RF_Module:ESP32-S2-MINI-1',
              ...
              sch_pos=(200, 80), pcb_pos=(5.25, 8.4), pcb_rot=90)
    for n in range(1, 66):
    ...
    d.add(Part('C5', 'Device:C', '100nF', C0402, {'1': '+3V3', '2': 'GND'}, lcsc='C1525', desc='100nF 16V X7R 0402', sch_pos=(158, 40), pcb_pos=(11.4, 6.5), **B))
    d.add(Part('R3', 'Device:R', '10k', R0402, {'1': '+3V3', '2': 'EN'}, lcsc='C25744', desc='10k 0402', sch_pos=(150, 65), pcb_pos=(11.4, 8.0), **B))
    d.add(Part('C6', 'Device:C', '1uF', C0402, {'1': 'EN', '2': 'GND'}, lcsc='C52923', desc='1uF 25V X5R 0402 (EN reset delay)', sch_pos=(158, 78), pcb_pos=(11.4, 9.5), **B))
    d.add(Part('R4', 'Device:R', '10k', R0402, {'1': '+3V3', '2': 'IO0_BOOT'}, lcsc='C25744', desc='10k 0402', sch_pos=(150, 110), pcb_pos=(11.4, 11.0), **B))
    ...
    d.add(Part('D1', 'Diode:SM712_SOT23', 'PSM712', SOT23, {'1': 'DMX_A', '2': 'DMX_B', '3': 'GND'},
               lcsc='C32677', mpn='PSM712-LF-T7', desc='RS-485 TVS array +12/-7 V SOT-23', sch_pos=(330, 90), pcb_pos=(17.9, 18.4), pcb_rot=90, **B))
    ...
    d.add(Part('R8', 'Device:R', '330R', R0402, {'1': 'LED_DATA', '2': 'LED_DATA_R'}, lcsc='C25104', desc='330R 0402 series (WS2812 data)', sch_pos=(145, 215), pcb_pos=(11.4, 14.0), **B))
    d.add(Part('C8', 'Device:C', '100nF', C0402, {'1': '+3V3', '2': 'GND'}, lcsc='C1525', desc='100nF 16V X7R 0402', sch_pos=(180, 195), pcb_pos=(12.6, 15.6), **B))
    d.add(Part('R5', 'Device:R', '10k', R0402, {'1': '+3V3', '2': 'BTN_USER'}, lcsc='C25744', desc='10k 0402', sch_pos=(200, 195), pcb_pos=(11.4, 12.5), **B))
    ...
    d.add(Part('R9', 'Device:R', '1k', R0402, {'1': 'BUZZER', '2': 'Q1_B'}, lcsc='C11702', desc='1k 0402', sch_pos=(222, 250), pcb_pos=(5.35, 1.8), **B))
    d.add(Part('Q1', 'Transistor_BJT:S8050', 'S8050', SOT23, {'2': 'Q1_B', '1': 'GND', '3': 'BZ_N'},
               lcsc='C2146', mpn='S8050', desc='NPN 0.5A SOT-23 buzzer driver', sch_pos=(240, 250), pcb_pos=(2.5, 3.5), **B))
    ...
    d.add(Part('BZ1', 'Device:Buzzer', 'MLT-8530', 'Buzzer_Beeper:MagneticBuzzer_CUI_CMT-8504-100-SMT', {'1': '+5V', '2': 'BZ_N'},
               lcsc='C94599', mpn='MLT-8530', desc='Magnetic buzzer 8.5x8.5 mm SMD, passive, 16 ohm', sch_pos=(245, 200), pcb_pos=(5.3, 10.5), extra_pads={'3': 'GND', '4': 'GND'}, **B))
    # ------------------------------------------------ test pads (I2C expansion, UART0)
    d.texts += [('Test pads: I2C expansion and UART0', 272, 165, 2.5, True)]
    d.boxes += [(270, 158, 412, 230)]
    for i, (net, x) in enumerate([('+3V3', 28.5), ('GND', 31.2), ('EXP_SDA', 33.9), ('EXP_SCL', 36.6), ('TXD0', 28.5), ('RXD0', 31.2)], 1):
        d.add(Part(f'TP{i}', 'Connector:TestPoint', net, TP, {'1': net}, desc='Test pad 1.5 mm', sch_pos=(290 + 18 * i, 190), pcb_pos=(x, 24.0 if i <= 4 else 26.6), **B))
    ...
    d.silk = [
        ('BOOT', 15.3, 18.7, 0.8, 0, 'F.SilkS', False),
        ('USER', 15.3, 27.4, 0.8, 0, 'F.SilkS', False),
        ('DMX mini rev A', 32.0, 14.5, 0.8, 0, 'B.SilkS', True),
        ('DMX OUT', 25.5, 3.0, 0.8, 0, 'B.SilkS', True),
        ('3V3 GND SDA SCL', 32.5, 22.1, 0.8, 0, 'B.SilkS', True),
        ('TX0 RX0', 35.0, 26.6, 0.8, 0, 'B.SilkS', True),
    ]
    return d
