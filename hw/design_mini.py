...
def build():
    ...
    d.rev = 'A-mini'
    d.board = dict(w=38.5, h=28.5, corner=0.6, layers=4, usb_vbus_via=4.4, inner_planes={'In1.Cu': 'GND', 'In2.Cu': '+3V3'}, min_width=0.1, min_clearance=0.1)
    ...
    d.add(Part('J1', 'Connector:USB_C_Receptacle_USB2.0_16P', 'USB-C 16P', 'Connector_USB:USB_C_Receptacle_HRO_TYPE-C-31-M-12',
               ...
               sch_pos=(45, 65), pcb_pos=(6.4, 25.4), pcb_rot=0))
    d.add(Part('R1', 'Device:R', '5.1k', R0402, {'1': 'CC1', '2': 'GND'}, lcsc='C25905', desc='5.1k 0402 1% (USB-C CC pull-down)', sch_pos=(75, 80), pcb_pos=(3.4, 27.7), **B))
    d.add(Part('R2', 'Device:R', '5.1k', R0402, {'1': 'CC2', '2': 'GND'}, lcsc='C25905', desc='5.1k 0402 1% (USB-C CC pull-down)', sch_pos=(85, 80), pcb_pos=(9.4, 27.7), **B))
    d.add(Part('U4', 'Power_Protection:USBLC6-2SC6', 'USBLC6-2SC6', SOT23_6,
               {'1': 'USB_D+', '6': 'USB_D+', '3': 'USB_D-', '4': 'USB_D-', '2': 'GND', '5': 'VBUS'},
               lcsc='C7519', mpn='USBLC6-2SC6', desc='USB ESD protection array', sch_pos=(100, 100), pcb_pos=(6.4, 26.5), pcb_rot=0, **B))
    d.add(Part('F1', 'Device:Polyfuse', '0.75A PTC', 'Fuse:Fuse_0805_2012Metric', {'1': 'VBUS', '2': '+5V'},
               lcsc='C7472571', mpn='0805L075/6AR', desc='PTC resettable fuse 0805, 0.75 A hold, 6 V', sch_pos=(70, 40), pcb_pos=(13.6, 18.0), **B))
    d.add(Part('C1', 'Device:C', '10uF', C0603, {'1': '+5V', '2': 'GND'}, lcsc='C19702', desc='10uF 10V X5R 0603', sch_pos=(82, 50), pcb_pos=(3.0, 19.3), pcb_rot=90, **B))
    d.add(Part('U2', 'Regulator_Linear:AP2112K-3.3', 'AP2112K-3.3', SOT23_5,
               ...
               sch_pos=(100, 40), pcb_pos=(13.8, 22.0), **B))
    d.add(Part('C2', 'Device:C', '10uF', C0603, {'1': '+3V3', '2': 'GND'}, lcsc='C19702', desc='10uF 10V X5R 0603', sch_pos=(115, 50), pcb_pos=(14.5, 24.8), **B))
    d.add(Part('C3', 'Device:C', '100nF', C0402, {'1': '+3V3', '2': 'GND'}, lcsc='C1525', desc='100nF 16V X7R 0402', sch_pos=(122, 50), pcb_pos=(10.6, 19.8), pcb_rot=90, **B))
    ...
    U1 = Part('U1', 'RF_Module:ESP32-S3-MINI-1', 'ESP32-S3-MINI-1-N8', 'RF_Module:ESP32-S2-MINI-1',
              ...
              sch_pos=(200, 80), pcb_pos=(5.25, 8.8), pcb_rot=90)
    for n in range(1, 66):
    ...
    d.add(Part('SW2', 'Switch:SW_Push', 'BOOT', SW_TACT, {'1': 'IO0_BOOT', '2': 'GND'}, lcsc='C720477', mpn='TS-1088-AR02016', desc='Tactile switch 3.9x3x2 mm SMD', sch_pos=(150, 130), pcb_pos=(15.3, 21.4)))
    # ------------------------------------------------ DMX / RS-485
    ...
    d.add(Part('D1', 'Diode:SM712_SOT23', 'PSM712', SOT23, {'1': 'DMX_A', '2': 'DMX_B', '3': 'GND'},
               lcsc='C32677', mpn='PSM712-LF-T7', desc='RS-485 TVS array +12/-7 V SOT-23', sch_pos=(330, 90), pcb_pos=(17.9, 18.9), pcb_rot=90, **B))
    ...
    d.add(Part('J2', 'Connector_Audio:XLR5_Ground', 'XLR-5 female (DMX OUT)', 'Connector_Audio:Jack_XLR_Neutrik_NC5FAH_Horizontal',
               ...
               lcsc='C368501', mpn='NC5FAH', desc='Neutrik XLR 5-pin female, horizontal PCB mount (DMX OUT)', sch_pos=(385, 60), pcb_pos=(21.35, 10.05), pcb_rot=0))
    # ------------------------------------------------ UI
    ...
    d.add(Part('SW3', 'Switch:SW_Push', 'USER', SW_TACT, {'1': 'BTN_USER', '2': 'GND'}, lcsc='C720477', mpn='TS-1088-AR02016', desc='Tactile switch 3.9x3x2 mm SMD (snooze / manual on)', sch_pos=(200, 215), pcb_pos=(15.3, 25.5)))
    ...
    for i, (net, x) in enumerate([('+3V3', 28.5), ('GND', 31.2), ('EXP_SDA', 33.9), ('EXP_SCL', 36.6)], 1):
        d.add(Part(f'TP{i}', 'Connector:TestPoint', net, TP, {'1': net}, desc='Test pad 1.5 mm', sch_pos=(290 + 18 * i, 190), pcb_pos=(x, 25.0), **B))
    ...
    d.silk = [
        ('BOOT', 15.3, 19.2, 0.8, 0, 'F.SilkS', False),
        ('USER', 15.3, 27.9, 0.8, 0, 'F.SilkS', False),
        ('DMX mini rev A', 32.0, 14.5, 0.8, 0, 'B.SilkS', True),
        ('DMX OUT', 25.5, 3.0, 0.8, 0, 'B.SilkS', True),
        ('3V3 GND SDA SCL', 32.5, 23.0, 0.8, 0, 'B.SilkS', True),
    ]
    return d
